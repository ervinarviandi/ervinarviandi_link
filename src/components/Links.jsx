        ...
        <div className="grid md:grid-cols-2 gap-5 mt-4">
          <div className="flex flex-col">
            <a href="https://ervinarvian.vercel.app/" aria-label="right icons">
              <div className="border-2 border-gray-200 p-4 rounded-lg relative hover:bg-gradient-to-r from-green-200 to-purple-300 duration-300 ease-in" aria-label="link pembungkus personal portfolio" role="link">
                <div className="flex  items-center gap-x-3">
          ...
          <div className="flex flex-col">
            <a href="https://app.gitbook.com/o/vXWd1hsKDlQ1x5wo7ASa/s/AoqsT3g63kOfLrnoT3nF/untitled/astro-introduction">
              <div className="border-2 border-gray-200 p-4 rounded-lg relative hover:bg-gradient-to-r from-green-200 to-purple-300 duration-300 ease-in" aria-label="link pembungkus blog" role="link">
                <div className="flex  items-center gap-x-3">
          ...
          <div className="flex flex-col">
            <a href="https://trakteer.id/ervinarviandi" aria-label="trakteer link">
              <div className="border-2 border-gray-200 p-4 rounded-lg relative  hover:bg-gradient-to-r from-green-200 to-purple-300 duration-300 ease-in" aria-label="link pembungkus buy me a cup coffee" role="link">
                <div className="flex  items-center gap-x-3">
